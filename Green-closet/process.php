...
?>
  ...
  <form method="POST" action="process.php" id="sort-form" class="d-flex align-items-center">
  <h6 class="m-4">Sort By:</h6>
  <select name="sort" class="btn btn-dark flex-fill text-light px-3 p-2 mx-3 m-2" onchange="document.getElementById('sort-form').submit();">
    <option value="default">Default</option>
    <option value="price_high">Low to High</option>
    <option value="price_low">High to Low</option>
